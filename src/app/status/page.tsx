      ...
      >
        ...
        {questionnaireEntry ? (
          ...
          <div className="bg-base-100 p-8 rounded-box mt-8 border border-accent">
            ...
            <p className="text-center mt-4">
              ...
              <span className="font-bold">
                {QStatus[questionnaireEntry.status]}
              </span>
            </p>
            <p className="text-center mt-4">
          ...
          <div className="bg-base-100 p-8 rounded-box mt-8 border border-accent">
            ...
            <div className="divider "></div>
            <p className="text-center mt-4">
              Please enter your confirmation code to check the status of your
              request
            </p>
            <input
              type="text"
            ...
            {invalid && (
              <div>
                ...
                <p className="text-center ">
                  <Link
                    href="/login"
                    className="text-center text-info font-bold"
                  >
                    <div className="font-bold">
                      Alternatively, you can access and edit your request by
                      logging in!
                    </div>
                    Log in here!
                  </Link>
